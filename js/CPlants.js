...
oPeashooter = InheritO(CPlants, {
    ...
    Tooltip: "向敌人射出子弹",
    Produce: '中国工农红军是中国土地革命战争时期，中国</font><br>共产党领导的人民军队。简称“红军”。中国</font><br>人民解放军的前身。<p>伤害：<font color="#FF0000">中等</font></p>“一支刚成立的政党，怎么能如此快的发展，</font><br>引得无数同胞入党，还有这么强的军事？红军：</font><br>努力干活，奉献自身,再加上同志们的努力，正</font><br>确的领导人和思想教育，这样的主义能让一切</font><br>成为可能！”',
    PrivateBirth: function(a) {
...
oSunFlower = InheritO(CPlants, {
    ...
    Tooltip: "提供你额外的物资",
    Produce: '中华民国，为你提供额外物资的友军。尝试</font><br>尽可能多的放置吧！<p>物资产量：<font color="#FF0000">中等</font></p>“中华民国情不自禁的和节拍跳起舞，是什</font><br>么节拍呢，嗨！是抗日胜利那一场载歌载舞，</font><br>这美妙的歌曲，可惜......很多同志都不在了”',
...
oTwinSunflower2 = InheritO(oSunFlower, {
    ...
    PrivateBirth: function(a) {
        ...
        function(f, d, c, e) {
            $P[f] && (a.ChangePosition($(f), 1), oSym.addTask(100,
            function(k, h, g, j, i) {
                AppearSun(Math.floor(h + Math.random() * 20), j, 50, 0),
                AppearSun(Math.floor(g + Math.random() * 20), j, 50, 0),
...
oOxygen = InheritO(CPlants, {
    ...
    Tooltip: "希腊球可以提供氧气给地上的友军",
    Produce: '希腊球可以提供氧气给地上的友军<p>韧性：<font color="FF0000">中</font><p><font color="#000000">范围：<font color="#1F470B">3x3</font></p>希望群里的宝开语大师填写该内容',
    //GetDY: function(b, c, a) {
    //    return 6
    //},
    CanGrow: function(e, d, f) {
