...
oZombie = InheritO(OrnNoneZombies, {
    ...
    Produce: '韧性：<font color="#FF0000">低</font></p>“小鬼子，贪婪，残忍，不知足，不知道他们的天皇究竟有什么崇高的魅力。”'
}),
...
oImp = InheritO(OrnNoneZombies, {
    ...
    Produce: '伪满洲国们是一群小型敌军，他们被日本帝国傀儡。</p><p>韧性：<font color="#FF0000">低</font><br>“大清末代皇帝成为日本傀儡在东三省建立的伪政权，这一点也不好笑。”'
}),
...
oCZombie = InheritO(OrnNoneZombies, {
    ...
    Produce: '被吃掉板栗仁只剩壳(并且还臭了)的板栗(不是什么好东西)。<p>韧性：<font color="#FF0000">低</font></p>"偶,亲爱的达瓦里氏,你看看你都臭了。",板栗嘲讽的对庶民板栗说,"真的是糟糕透了!"',
}),
...
oCConeheadZombie = InheritO(OrnIZombies, {
    ...
    Produce: '他的篮球使他更能经受打击<p>特点：<font color="#FF0000">携带一颗篮球</font></p>“篮球？篮球！”它一直这么说，但可笑的是它连投篮都不会，但他上过比赛！虽然因为用球砸人被禁赛了，但他对篮球114514分的热情仍未减退。（冷知识：篮球栗是Countryball lite第一个拥有动态贴图的敌军，虽然只有三帧）',
});
