...
ViewPlantTitle = function(b) {
    ...
    e = ArCard[b],
    c = e.PName.prototype,
    a = c.CName; ! oS.CardKind && (a += "<br>冷却时间:" + c.coolTime + "秒<br>" + c.Tooltip, !e.CDReady && (a += '<br><span style="color:#F00">正在重新装填中...</span>')); ! e.SunReady && (a += '<br><span style="color:#F00">物资不足!</span>');
    f.innerHTML = a;
    SetStyle(f, {
        top: 60 * b + "px",
