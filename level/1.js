            ...
            e < 990 ? oSym.addTask(3, arguments.callee, [e, h, b, d, c, g, a, f]) : (ClearChild($("SodRoll_1"), $("SodRollCap_1")), (function() {
                ...
                oP.Monitor({
                    ...
                    f: function(k) {
                        ...
                        switch (k) {
                        case 0:
                            innerText($("DivTeach"), "点击放置友军");
                            NewImg("PointerUD", "images/interface/PointerUP.gif", "top:60px;left:50px", EDAll);
                            oSym.addTask(10, arguments.callee, [++k]);
                            break;
                        case 1:
                            i > 0 && (innerText($("DivTeach"), "哎！tnnd！放啊！"), EditImg($("PointerUD"), "", "images/interface/PointerDown.gif", {
                                left: "170px",
                                top: "270px"
                            }), ++k);
                            oSym.addTask(10, arguments.callee, [k]);
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            oS.SunNum > 99 && (innerText($("DivTeach"), "点击红军球，再放一位！"), EditImg($("PointerUD"), "", "images/interface/PointerUP.gif", {
                                left: "50px",
                                top: "60px",
                                visibility: "visible"
                            }), ++k);
                        ...
                        default:
                            ...
                            j > 0 ? (SetHidden($("PointerUD")), innerText($("DivTeach"), "别让八嘎靠近你的领土！"), oP.AddZombiesFlag(), oSym.addTask(500, SetNone, [$("DivTeach")])) : oSym.addTask(10, arguments.callee, [4])
                        }
                    }
                });
                BeginCool();
